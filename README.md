...
2. Go to **Settings > Secrets and variables > Actions** in your fork and add a repository secret named `GEMINI_API_KEY`.
...
**使用方法：**
1. Fork 本仓库。
2. 在你 Fork 的仓库中进入 **Settings > Secrets and variables > Actions**，添加一个名为 `GEMINI_API_KEY` 的 Repository Secret。
